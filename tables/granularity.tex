...
\begin{table}[ht!]
\centering
\caption{\rnn{} parameters for the different calorimeter sampling layers and sections. The \rnn{} algorithm parameters are dependent on the layer $l$ but independent of \et{}. The reconstruction parameters are the cell size in \eta{} ($h_{\eta,l}$), $\phi$ ($h_{\phi,l}$) and the number of rings to be computed in each layer ($N_l$).
}%
